  ...
  return (
    <div className="space-y-8">
        ...
        <Card className="bg-gym-gray-dark border-gym-gray-light">
          ...
          <CardContent>
            ...
            <p className="text-white/50 text-xs mt-2">
              Coupon applies only for the first 30 members combined across all services
            </p>
          </CardContent>
        </Card>
      </div>

      {/* Main tabs - Updated to have only Coupons and Services tabs */}
      <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
        ...
        {/* Coupons Content - Only render when active to prevent unnecessary initialization */}
