    ...
    <div className="bg-gym-gray-dark p-4 md:p-6 rounded-lg shadow-md border border-gym-gray-light">
      <div className="mb-4 md:mb-6 flex flex-col md:flex-row justify-between md:items-center gap-3">
        <div>
          ...
          <div className="text-white/50 text-xs mt-1">
            <p>Note: Coupons are limited to the first 30 members across all services</p>
            <p className="mt-1">Fixed coupon prices: <span className="text-gym-yellow">Weight Loss ₹3000</span> | <span className="text-gym-yellow">Strength ₹1500</span> | <span className="text-gym-yellow">Zumba ₹1500</span></p>
          </div>
          {totalRedemptions > 0 && coupons.length === 0 && (
            <p className="mt-1 text-yellow-500/80">
              Warning: {totalRedemptions} redemption{totalRedemptions !== 1 ? 's' : ''} exist{totalRedemptions === 1 ? 's' : ''} in the system from previously used coupons.
            </p>
          )}
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
          ...
          {!hideAddButton && (
            <Button 
              ...
              className="w-full sm:w-auto bg-gym-yellow text-gym-black hover:bg-gym-yellow/90"
            >
      ...
      {loading ? (
        ...
        <div className="text-center py-10 text-white/60">
          {searchQuery ? "No coupons match your search." : "No coupons found. Create your first coupon to get started."}
        </div>
      ) : (
